  ...
  return (
    <>
      ...
      <button
        ...
        className="hidden md:flex fixed md:bottom-6 md:right-6 z-40 items-center gap-1.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-300 text-xs font-medium px-3 py-2 rounded-full shadow-lg transition-all hover:scale-105"
      >
